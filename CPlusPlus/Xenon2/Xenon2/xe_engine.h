#pragma once
#define NO_LOAD_ENGINE
#include "xenon.h"
#include "xe_surface.h"
#include "xe_deviceManager.h"
...
"VK_LAYER_KHRONOS_validation"
	...
	*/
	...
	[[deprecated("Relocated to utility class")]]
	VkImageView createImageView(VkImage image, VkFormat format, VkImageAspectFlags aspectFlags, uint32_t mipLevels) {
		
		return utility.createImageView(image, format, aspectFlags, mipLevels);
	}

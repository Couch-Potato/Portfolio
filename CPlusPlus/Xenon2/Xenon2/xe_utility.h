...
/*
Statefully attached utilty class that provides functions related to an engine object but we do not want to clutter the main engine class so we defer them to a specific utility class purely for organizational reasons
*/
...
public:
	...
	VkPhysicalDevice* physicalDevice;  // TODO: SET A DAMN DEVICE!
	VkDevice* device; // TODO: SET A DAMN DEVICE!

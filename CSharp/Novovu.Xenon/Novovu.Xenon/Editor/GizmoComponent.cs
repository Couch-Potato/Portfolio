...
namespace Novovu.Xenon.Editor
{
    public class GizmoComponent
    {
        ...
        protected void PickObject(Vector2 mousePosition, bool removeFromSelection)
        {
            ...
            Engine.Engine.EventModel.InvokeSelection(obj);
            if (obj != null)
                Selection.Add(obj);
        }
        ...
        public void Draw()
        {
            ...
            for (int i = 0; i < 3; i++) //(order: x, y, z)
            {
                ...
                {
                    case GizmoMode.Translate:
                        activeModel = GeometricObjects.Translate;
                        break;
                    case GizmoMode.Rotate:
                        activeModel = GeometricObjects.Rotate;
                        break;
                    default:
                        activeModel = GeometricObjects.Scale;
                        break;
                }
